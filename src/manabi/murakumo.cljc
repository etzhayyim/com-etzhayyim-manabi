...
(defn collection
  [name]
  (str "com.etzhayyim.manabi." name))

(def cell-specs {
  :literacy {:legacy-cell "literacy"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "literacy")]
     :required-gates common-gates
     :trigger "manifest cell literacy"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :numeracy {:legacy-cell "numeracy"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "numeracy")]
     :required-gates common-gates
     :trigger "manifest cell numeracy"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :civics_charter {:legacy-cell "civics-charter"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "civics_charter")]
     :required-gates common-gates
     :trigger "manifest cell civics_charter"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :vocational {:legacy-cell "vocational"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "vocational")]
     :required-gates common-gates
     :trigger "manifest cell vocational"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :lifelong_inquiry {:legacy-cell "lifelong-inquiry"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "lifelong_inquiry")]
     :required-gates common-gates
     :trigger "manifest cell lifelong_inquiry"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :cert_prep {:legacy-cell "cert-prep"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "cert_prep")]
     :required-gates common-gates
     :trigger "manifest cell cert_prep"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
